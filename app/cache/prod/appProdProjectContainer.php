...
class appProdProjectContainer extends Container
{
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        $j = new \Symfony\Component\Security\Http\EntryPoint\BasicAuthenticationEntryPoint('Introducir usuario y contraseña');
        return $this->services['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($g, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('security.user.provider.concrete.in_memory')), 'secured_area', $a, $this->get('event_dispatcher', ContainerInterface::NULL_ON_INVALID_REFERENCE)), 2 => $i, 3 => new \Symfony\Component\Security\Http\Firewall\BasicAuthenticationListener($b, $d, 'secured_area', $j, $a), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '550276da64c05', $a), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $g, $d)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $h, 'secured_area', $j, NULL, NULL, $a));
    }
    ...
    protected function getSecurity_User_Provider_Concrete_InMemoryService()
    {
        ...
        $instance->createUser(new \Symfony\Component\Security\Core\User\User('usuario', 'fandf', array(0 => 'ROLE_USER')));

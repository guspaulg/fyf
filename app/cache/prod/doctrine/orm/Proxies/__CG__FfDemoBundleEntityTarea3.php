 ...
 */
class Tarea3 extends \Ff\DemoBundle\Entity\Tarea3 implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'fecha_inicio', 'fecha_final');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Tarea3 $proxy) {

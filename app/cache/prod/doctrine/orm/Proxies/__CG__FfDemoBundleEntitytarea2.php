 ...
 */
class tarea2 extends \Ff\DemoBundle\Entity\tarea2 implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'disciplina', 'fecha_inicio', 'fecha_final', 'precio', 'tipodepago', 'veces');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (tarea2 $proxy) {

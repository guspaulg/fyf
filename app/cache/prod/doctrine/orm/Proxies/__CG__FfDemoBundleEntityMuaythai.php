 ...
 */
class Muaythai extends \Ff\DemoBundle\Entity\Muaythai implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'fecha_inicio', 'precio', 'sexo', 'veces', 'idpago');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Muaythai $proxy) {
